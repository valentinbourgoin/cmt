...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'team_player', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team.Team'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.team'
        db.delete_column(u'team_player', 'team_id')
