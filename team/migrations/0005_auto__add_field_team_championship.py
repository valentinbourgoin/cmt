...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.championship'
        db.add_column(u'team_team', 'championship',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team.Championship'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.championship'
        db.delete_column(u'team_team', 'championship_id')
